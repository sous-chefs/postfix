...
default['postfix']['master']['tlsmgr']['private'] = false
...
default['postfix']['master']['rewrite']['private'] = false
...
default['postfix']['master']['bounce']['private'] = false
...
default['postfix']['master']['defer']['private'] = false
...
default['postfix']['master']['trace']['private'] = false
...
default['postfix']['master']['verify']['private'] = false
...
default['postfix']['master']['proxymap']['private'] = false
...
default['postfix']['master']['relay']['order'] = 160
default['postfix']['master']['relay']['type'] = 'unix'
default['postfix']['master']['relay']['private'] = false
default['postfix']['master']['relay']['chroot'] = false
default['postfix']['master']['relay']['command'] = 'smtp'
default['postfix']['master']['relay']['args'] = ['-o smtp_fallback_relay=', '-o smtp_helo_timeout=5', '-o smtp_connect_timeout=5']

default['postfix']['master']['showq']['active'] = true
default['postfix']['master']['showq']['order'] = 170
...
default['postfix']['master']['error']['order'] = 180
default['postfix']['master']['error']['type'] = 'unix'
default['postfix']['master']['error']['private'] = false
...
default['postfix']['master']['discard']['order'] = 190
default['postfix']['master']['discard']['type'] = 'unix'
default['postfix']['master']['discard']['private'] = false
...
default['postfix']['master']['local']['order'] = 200
default['postfix']['master']['local']['type'] = 'unix'
default['postfix']['master']['local']['private'] = false
...
default['postfix']['master']['virtual']['order'] = 210
default['postfix']['master']['virtual']['type'] = 'unix'
default['postfix']['master']['virtual']['private'] = false
...
default['postfix']['master']['lmtp']['order'] = 220
default['postfix']['master']['lmtp']['type'] = 'unix'
default['postfix']['master']['lmtp']['private'] = false
...
default['postfix']['master']['anvil']['order'] = 230
default['postfix']['master']['anvil']['type'] = 'unix'
default['postfix']['master']['anvil']['private'] = false
...
default['postfix']['master']['scache']['order'] = 240
default['postfix']['master']['scache']['type'] = 'unix'
default['postfix']['master']['scache']['private'] = false
...
default['postfix']['master']['maildrop']['comment'] = 'Interfaces to non-Postfix software.'
...
default['postfix']['master']['cyrus']['order'] = 520
...
default['postfix']['master']['uucp']['order'] = 530
...
default['postfix']['master']['ifmail']['order'] = 540
...
default['postfix']['master']['bsmtp']['order'] = 550
