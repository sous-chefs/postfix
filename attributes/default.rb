...
default['postfix']['sasl_use_encrypted_bag'] = false
default['postfix']['sasl_encrypted_data_bag_name'] = 'passwords'
default['postfix']['sasl_encrypted_data_bag_element'] = 'postfix'
